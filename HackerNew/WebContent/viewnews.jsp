...
<html>
    ...
    <body>
        ...
        <%@page import="com.model.dao.NewDao,com.model.*,java.util.*"%>
        <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>

        <h1>Lista de todos las noticias</h1>

        <%
            List<New> list = NewDao.getAllRecords();
            request.setAttribute("list", list);
        %>

        <table border="1" width="90%">
            <tr><th>Id</th><th>Title</th><th>Url</th><th>text</th><th>Puntuacion</th><th>Edit</th><th>Delete</th></tr>
                    <c:forEach items="${list}" var="n">
                <tr><td>${n.getId()}</td><td>${n.getTitle()}</td><td>${n.getUrl()}</td><td>${n.getText()}</td><td>  <div class="progress">
  <div class="progress-bar" role="progressbar" aria-valuenow="70"
  aria-valuemin="0" aria-valuemax="100" style="width:${n.getProgress()}%">
    ${n.getProgress()}%
  </div>
</div>   </td><td><a href="editformnew.jsp?id=${n.getId()}">Edit</a></td><td><a href="viewnews.jsp?id=${n.getId()}">Delete</a></td></tr>
            </c:forEach>
        </table>
        <br/><a href="news.jsp">Agregar Noticia</a>
