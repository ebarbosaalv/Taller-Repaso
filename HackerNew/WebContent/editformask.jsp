...
<html>
    <head>
        ...
        <title>Editar</title><meta name="viewport" content="width=device-width, initial-scale=1">
        <link rel="stylesheet"
    ...
    <body>
        <%@page import="com.model.dao.AskDao,com.model.Ask"%>

        <%
            String id = request.getParameter("id");
            Ask a = AskDao.getRecordById(Integer.parseInt(id));
        %>

        <h1>Editar Usuario</h1>
        <form action="editask.jsp" method="post">
            <input type="hidden" name="id" value="<%=a.getId()%>"/>
            <table>
                <tr><td>Texto Pregunta:</td><td><input type="text" name="text" value="<%= a.getText()%>"/></td></tr>
