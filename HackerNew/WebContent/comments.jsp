...
<center>
    <table id="hnmain" border="0" cellpadding="0" cellspacing="0"
            ...
            <tr>
                <td><form method="post" action="/r">
                        <input type="hidden" name="fnid" value="QXTcv6OHsxgBjtaBDPD2ux"><input
                            type="hidden" name="comment" value="submit-page">
                        ...
                        <form method="post" action="viewcomments.jsp">
                            <tr>
                                <td></td>
        ...
        <a href="viewcomments.jsp" class="btn btn-warning" role="button">Mostrar Comentario</button></a>
        <br><br>

        <b>Ingrese su comentario</b>



        <form method="post" action="CommentServlet1">
            <td><textarea name="comment" rows="4" cols="49"></textarea></td>
