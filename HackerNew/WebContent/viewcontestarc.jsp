...
<body>
    ...
    <%@page import="com.model.dao.ContestarComentarioDao,com.model.*,java.util.*"%>
 ...
 Comentarios</h1>
    ...
    <%
        List<Comment> list = com.model.dao.ContestarComentarioDao.getAllRecords();
        request.setAttribute("list", list);
    %>

    <table border="1" width="90%">
        <tr><th>Id</th><th>comentarios</th><th>Edit</th><th>Eliminar</th></tr>
                <c:forEach items="${list}" var="c">
            <tr><td>${c.getId()}</td><td>${c.getComment()}</td><td><a href="editformcomments.jsp?id=${c.getId()}">Editar</a></td><td><a href="viewcomments.jsp?id=${c.getId()}">Eliminar</a></td></tr>
        </c:forEach>
    </table>
...
<%@page import="com.model.dao.ContestarComentarioDao"%>
<jsp:useBean id="c" class="com.model.Comment"></jsp:useBean>
<jsp:setProperty property="*" name="c"/>
<%
    ContestarComentarioDao.delete(c);
